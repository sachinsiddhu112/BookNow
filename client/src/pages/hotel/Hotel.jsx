...
export default function Hotel() {
  ...
  useMemo(() => {
    ...
    rooms.then((room)=>{
      ...
      freeRooms.current=0;
      room[len-1].roomNumbers.map((roomNumber,i)=>{
       
       isAvailabel(roomNumber)?freeRooms.current=freeRooms.current + 1:console.log("not free");

       
      })
     console.log(freeRooms," ",options.room);
  })
  return;
  },[id])
        ...
        <div className="hotelContainer">
          ...
          <div className="hotelWrapper">
            ...
            <div className="hotelDetials">
              ...
              {
              freeRooms.current>=options.room?(
